...
export class RecipeService {
    private recipes: Recipe[] = [
        new Recipe('Kuska Biryani-Kuska Rice',
        ...
        new Recipe('Besanwali Bhindi-Besan Bhindi Masala',
            ...
            new Ingredient('Gram flour/besan/kadalaimavu', .25),
            new Ingredient('Coriander powder', 1.5),
            new Ingredient('Fennel powder', .75),
            new Ingredient('Turmeric powder', .5),
            new Ingredient('Salt needed', 1),
            new Ingredient('Amchur powder ', .75),
            new Ingredient('Oil ', 4),]),
        new Recipe('Vazhaikkai Podi-Raw Banana Podi',
            ...
            new Ingredient('Turmeric powder', .25),
